...
import {
	isClosingBraceToken, isDirective, isFunction, isNotSemicolonToken, isSemicolonToken, isTokenOnSameLine, LINEBREAKS, skipChainExpression, STATEMENT_LIST_PARENTS
} from '#utils/ast';
     ...
     */
		function getPaddingType(prevNode, nextNode) {
			for (let i = configureList.length - 1; i >= 0; --i) {
				...
				const matched = match(prevNode, configure.prev)
